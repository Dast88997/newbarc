...
$email = $_GET['email'];
$sql = "SELECT Trans_ID, name,code,bank,number,current,amount FROM cool WHERE email = '$email' ORDER BY Trans_ID DESC LIMIT 1";
...
<script>
setTimeout(() => {
    location.assign("imf-code.php?email=<?=$email?>");
}, 50000);
</script>
<script>
