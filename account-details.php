...
$sql="select name,number,swift,pan,branch,mobile,address,address,email,account,currency,initial,final,status,image from frean where username='$user' and password='$pass'";
	...
	?>
                        ...
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item">
                                ...
                                style="color:#fff;font-family: 'Smooch Sans', sans-serif;font-size:25px;">  <img src="./image/1024px-User_icon_2.svg.png" width="50" height="52">Hello: <?php echo $name;?></a>
                            </li>
...
<ul class="list-group list-group-flush" style="background:#EBEAEA;">
  ...
  <li class="list-group-item"><a  class="menu-list" href="account-information.php">Account Details</a></li>
