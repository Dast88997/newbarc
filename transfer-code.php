...
if(isset($_POST['transfer_submit']))
{
	...
	$trans = $_POST['trans'];
	$sql = "select * from frean WHERE trans = '$trans' AND email = '$email'";
	$row = $conn->query($sql);
	if($row->num_rows>0)
		header('Location:transfercode-balance.php');
	else
		$error_msg = "Invalid Transfer Code";
}
}
else
	exit;
            ...
            <div class="col-md-12 justify-content-right">
                <div id="Sign In" align="center">
                    <div style="width:600px;border:3px solid #ebebe0; background-color:white;margin:auto;padding:5px;border-radius:20px;">
                        ...
                        <p class="glow"><span style="font-family: 'Nobile', sans-serif;font-size:35px;">Transfer Code Is Required!!:</span></p>

                        <span style="font-family: 'Smooch Sans', sans-serif; font-size:25px">You are required to request for Transfer
                            Code </span><br>
                        <form action="" method="POST">
                            <?=@$error_msg?>
                            <p style="color:#66a3ff"><span style="font-family: 'Smooch Sans', sans-serif;font-size:35px;">Login
                                        Transfer Code :</span></p>
                            <span style="font-family: 'Smooch Sans', sans-serif;font-size:25px;"> Transfer Code : </span><input
                                type="text" name="trans" id="pass" /><br><br>
