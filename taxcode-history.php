                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a
                                                        href="incometaxcode-history.php?delete=<?php echo $data['Trans_ID'];?>"><button>DELETE</button></a>
                                                </td>
                                            </tr>
...
?>
    ...
    <script>
    document.getElementsByClassName('list-group-item')[5].style.backgroundColor = "#046469";
    document.getElementsByClassName('menu-list')[5].style.color = "#fff";
    </script>
