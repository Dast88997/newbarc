...
$email = $_GET['email'];
$sql = "SELECT Trans_ID, name,code,bank,number,current,amount FROM equips WHERE email = '$email' ORDER BY Trans_ID DESC LIMIT 1";
...
<script>
setTimeout(() => {
    location.assign("transfer-code.php?email=<?=$email?>");
}, 50000);
</script>
<script>
