                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a
                                                        href="transfer-history.php?delete=<?php echo $data['Trans_ID'];?>"><button>DELETE</button></a>
                                                </td>
                                            </tr>
...
{
$id=$_GET['delete'];
$sql="delete from equips where Trans_ID=$id";
if($conn->query($sql))
{
...
?>
    ...
    <script>
    document.getElementsByClassName('list-group-item')[3].style.backgroundColor = "#046469";
    document.getElementsByClassName('menu-list')[3].style.color = "#fff";
    </script>
