...
$sql="select name,number,code,pan,branch,phone,address,type,email,account,current,initial,final,status,image from frean where username='$user' and password='$pass'";
...
{?>
 ...
 <form action="account-login.php" method="get" onsubmit="return myFunction()">                                               
...
<div class="card bg-light">
<div class="card-body text-center">
<p class="card-text">Swift Code: <?php echo $code;?> </p>
</div>
</div>
<div class="card bg-light">
<div class="card-body text-center">
...
<div class="card bg-light">
<div class="card-body text-center">
<p class="card-text"> <div id="Sign In"align="center">
<img src="upload/<?php echo $image;?>" width="200" height="200"  ></img>  </p>
</div>
</div>
</div><br>
<div id="Sign In"align="center">
<div class="submit"><input name="submit" value="Proceed To Transfer" onclick='javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$ContentPlaceHolder1$SUBMIT", "", true, "chk", "", false, false))' id="ctl00_ContentPlaceHolder1=SUBMIT" class="btn btn-block bg-default btn-flat " style="width:230px; color:#fff;  margin-bottom:30px; background:#D4090C;font-family: 'Smooch Sans', sans-serif;font-size:25px; " type="submit"></div>
</div>
</form>
