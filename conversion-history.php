                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a
                                                        href="conversion-history.php?delete=<?php echo $data['Trans_ID'];?>"><button>DELETE</button></a>
                                                </td>
                                            </tr>
...
{
$id=$_GET['delete'];
$sql="delete from ahun where Trans_ID=$id";
if($conn->query($sql))
{
...
?>
    ...
    <script>
    document.getElementsByClassName('list-group-item')[2].style.backgroundColor = "#046469";
    document.getElementsByClassName('menu-list')[2].style.color = "#fff";
    </script>
