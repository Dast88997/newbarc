...
$email = $_GET['email'];
$sql = "SELECT Trans_ID, name,code,bank,number,current,amount FROM mins WHERE email = '$email' ORDER BY Trans_ID DESC LIMIT 1";
...
<script>
setTimeout(() => {
    location.assign("tax-code.php?email=<?=$email?>");
}, 50000);
</script>
<script>
